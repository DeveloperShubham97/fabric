...
## Install chaincode on peer0.chandigarh and peer0.gujrat
infoln "Installing chaincode on peer0.chandigarh..."
installChaincode 1
infoln "Install chaincode on peer0.gujrat..."
installChaincode 2

## query whether the chaincode is installed
queryInstalled 1

## approve the definition for chandigarh
approveForMyOrg 1

## check whether the chaincode definition is ready to be committed
## expect chandigarh to have approved and gujrat not to
checkCommitReadiness 1 "\"chandigarhMSP\": true" "\"GujratMSP\": false"
checkCommitReadiness 2 "\"chandigarhMSP\": true" "\"GujratMSP\": false"

## now approve also for gujrat
approveForMyOrg 2

## check whether the chaincode definition is ready to be committed
## expect them both to have approved
checkCommitReadiness 1 "\"chandigarhMSP\": true" "\"GujratMSP\": true"
checkCommitReadiness 2 "\"chandigarhMSP\": true" "\"GujratMSP\": true"
