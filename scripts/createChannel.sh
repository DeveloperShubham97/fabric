...
infoln "Joining chandigarh peer to the channel..."
joinChannel 1
infoln "Joining gujrat peer to the channel..."
joinChannel 2

## Set the anchor peers for each org in the channel
infoln "Setting anchor peer for chandigarh..."
setAnchorPeer 1
infoln "Setting anchor peer for gujrat..."
setAnchorPeer 2
